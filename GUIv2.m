...
% Last Modified by GUIDE v2.5 13-Jun-2016 07:58:19
...
% --- Executes on button press in SRC1_SG_NO.
function SRC1_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC1_SG_NO'];
toggleNO(hObject,blockname);
...
% --- Executes on button press in SRC2_SG_NO.
function SRC2_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC2_SG_NO'];
toggleNO(hObject,blockname);
...
% --- Executes on button press in SRC3_SG_NO.
function SRC3_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC3_SG_NO'];
toggleNO(hObject,blockname);
...
% --- Executes on button press in SRC4_SG_NO.
function SRC4_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC4_SG_NO'];
toggleNO(hObject,blockname);
...
% --- Executes on button press in SRC5_SG_NO.
function SRC5_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC5_SG_NO'];
toggleNO(hObject,blockname);
...
% --- Executes on button press in SRC6_SG_NO.
function SRC6_SG_NO_Callback(hObject, eventdata, handles)
blockname = [ evalin('base','modelname') '/' evalin('base','subname') '/SRC6_SG_NO'];
toggleNO(hObject,blockname);
